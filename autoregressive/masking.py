...
This file is part of music-transformer (https://github.com/spectraldoy/music-transformer), Music-transformer is open-source software licensed under the terms of the GNU General
...
def create_look_ahead_mask(seq_len):
    ...
    return mask.float().to(torch.device('cuda'))
